...
st.title("Student Assignment Grade")
st.markdown("upload your assignment file and get the grade")

st.sidebar.title("📚 About")

st.sidebar.markdown("""
This application allows students to upload their assignment files and get an instant grade prediction.

**Features:**
- 📤 Upload your assignment (PDF, DOCX, or TXT)
- 🤖 Automatically evaluates and grades the assignment
- 📈 Provides feedback based on content and structure

**How to Use:**
1. Upload your assignment using the file uploader.
2. Wait for the grading process to complete.
3. View your grade and feedback instantly.

---

👨‍💻 **Developed by:** Pavan Kumar Medarametla  
📅 **Version:** 1.0  
""")
